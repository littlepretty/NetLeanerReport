...
We can also leverage linear models with nonlinear feature transformations to deal with sparse inputs,
...
\begin{figure*}[h]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/WideDeepModel.png}
