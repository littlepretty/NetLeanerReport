...
natural language processing, speech recognition and many other research branches in
artificial intelligence.
In this paper we conduct a comparative study of applying the cutting-edge deep learning
techniques in network intrusion detection system.
We first review existing works that adopted traditional machine learning and novel deep learning
approaches in the anomaly detection based intrusion detection system.
Then we describe several promising hall-of-fame deep learning approaches.
On the basis of TensorFlow, we implement the NetLearner library in order to compare
the performance of multi-layer perceptrons, restricted Boltzmann machine and autoencoders
